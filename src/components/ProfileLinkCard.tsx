...
import { Copy, Check, Link2, MessageSquare, ExternalLink } from "lucide-react";
    ...
    try {
      ...
      if (profile) {
        ...
        if (profile.discord_link_code) {
          setLinkCode(profile.discord_link_code);
        }
      }
    } catch (error) {
  ...
  return (
    <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-primary/10">
      <CardHeader>
        ...
        <CardDescription>
          Connect your Discord account to use slash commands and receive notifications
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              ...
              <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                ...
                <li>Open Discord and use: <code className="bg-background px-1 py-0.5 rounded">/linkaccount code:YOUR_CODE</code></li>
